        ...
        <Fragment>
            <div className="game">
                ...
                <div className="game-container">
                    ...
                    {/* VENTANA DE JUEVO */}
                    <Stage className="game-window" width={stageSize.width * scale * 2 * 1.2} height={stageSize.height / scale} scaleX={scale * 1.2} scaleY={scale * 1.2} imageSmoothingEnabled={false} x={0}>
                        {/* CAPA ESTÁTICA */}
                        <Layer>
                            {/* ZONA DEL MAZO */}
